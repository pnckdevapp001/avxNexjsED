...
const EpisodeInfo = (props) => {
    ...
    return (       
        ...
        <div className="pt-2 pb-8">
              <iframe className="w-full aspect-video sm: pr-4 pl-4" src={`https://www.2embed.ru/embed/tmdb/tv?id=${showid}&s=${seasonid}&e=${epid}`} frameBorder={`0`} allowFullScreen={true}></iframe>
          </div>
          </div>
     );
}
