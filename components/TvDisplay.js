    ...
    return (    
        <div className="popular-movies md:mx-24">
            ...
            <li className="flex-row list-none my-8 pr-2">
                    ...
                    <a className="Nextbutton rounded-md px-4 py-2 bg-zinc-800 text-green-800 hover:opacity-70">{`<`}</a>
                    </Link>
                </li>
              {pagenum.map((element, index) => {
                  return (
                    ...
                    <a className="Nextbutton rounded-md px-4 py-2 bg-zinc-800 text-red-800 hover:opacity-70">{element}</a>
                    </Link>
                </li>
                  )
              })}
